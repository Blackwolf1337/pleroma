...
defmodule Pleroma.Web.Router do
  ...
  pipeline :require_moderation_tag_account_activation do
    plug(:admin_api)
    plug(Pleroma.Web.Plugs.EnsureUserTag, "moderation_tag:account-activation")
  end
  ...
  # AdminAPI
  # admins and mods (staff) with moderation_tag:report-triage can perform these actions
  scope "/api/v1/pleroma/admin", Pleroma.Web.AdminAPI do
  ...
  # AdminAPI
  # admins and mods (staff) with moderation_tag:post-deletion can perform these actions
  scope "/api/v1/pleroma/admin", Pleroma.Web.AdminAPI do
  ...
  # AdminAPI
  # admins and mods (staff) with moderation_tag:account-restriction can perform these actions
  scope "/api/v1/pleroma/admin", Pleroma.Web.AdminAPI do
